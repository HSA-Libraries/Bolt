--> Copy the clBolt.Bench.Benchmark.exe to a separate folder along with all python scripts and run this batch script
--> This will benchmark the Routines for DATA_TYPE which is a MACRO in the Benchmark.cpp file. Set it to the Appropriate
