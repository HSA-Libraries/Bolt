...
int main(int argc, char* argv[])
{
    ...
    bolt::cl::sort(boltvector.begin(), boltvector.begin()+4);           //(12 32 45 71)26 80 53 33
    ...
    bolt::cl::sort (boltvector.begin()+4, boltvector.end(), myfunction); // 12 32 45 71(26 33 53 80)
