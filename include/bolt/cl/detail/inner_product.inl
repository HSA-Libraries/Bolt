...
namespace bolt {
    namespace cl {
        ...
        {
            return detail::inner_product_detect_random_access( ctl, first1, last1, first2, init, f1, f2, user_code, std::iterator_traits< InputIterator >::iterator_category( ) );
        }
        ...
        OutputType inner_product( InputIterator first1, InputIterator last1, InputIterator first2, OutputType init, 
            BinaryFunction1 f1, BinaryFunction2 f2, const std::string& user_code )
        {
            return detail::inner_product_detect_random_access( control::getDefault(), first1, last1, first2, init, f1, f2, user_code, std::iterator_traits< InputIterator >::iterator_category( ) );
        }
            ...
            const std::string& user_code )
        {
            ...
            return detail::inner_product_detect_random_access( ctl, first1, last1, first2, init, bolt::cl::plus< iType >( ), bolt::cl::multiplies< iType >( ), user_code, std::iterator_traits< InputIterator >::iterator_category( ) );
        }
        ...
        {
			typedef typename std::iterator_traits<InputIterator>::value_type iType;
            return detail::inner_product_detect_random_access( control::getDefault(), first1, last1, first2, init, bolt::cl::plus< iType >( ), bolt::cl::multiplies< iType >( ), user_code, std::iterator_traits< InputIterator >::iterator_category( ) );
        }
    ...
    namespace cl {
        namespace detail {
			 ...
			 struct CallCompiler_InnerProduct {
                static void constructAndCompile(::cl::Kernel *masterKernel,  std::string cl_code, std::string valueTypeName,  std::string functorTypeName1, std::string functorTypeName2, const control *ctl) {
                    ...
                    bolt::cl::constructAndCompileString( masterKernel, "innerProduct", inner_product_kernels, instantiationString, cl_code, valueTypeName, functorTypeNames, *ctl);
            ...
            template<typename InputIterator, typename OutputType, typename BinaryFunction1, typename BinaryFunction2> 
            OutputType inner_product_detect_random_access( bolt::cl::control& ctl, const InputIterator& first1, const InputIterator& last1, const InputIterator& first2, 
                const OutputType& init, const BinaryFunction1& f1, const BinaryFunction2& f2, const std::string& user_code, std::input_iterator_tag )
            {
            ...
            template<typename InputIterator, typename OutputType, typename BinaryFunction1, typename BinaryFunction2> 
            OutputType inner_product_detect_random_access( bolt::cl::control& ctl, const InputIterator& first1, const InputIterator& last1, const InputIterator& first2, 
                const OutputType& init, const BinaryFunction1& f1, const BinaryFunction2& f2, const std::string& user_code, std::random_access_iterator_tag )
            {
            ...
            */
            template<typename InputIterator, typename OutputType, typename BinaryFunction1,typename BinaryFunction2> 
            typename std::enable_if<!std::is_base_of<typename device_vector<typename std::iterator_traits<InputIterator>::value_type>::iterator,InputIterator>::value, OutputType>::type
            inner_product_pick_iterator(bolt::cl::control &ctl,  const InputIterator& first1, const InputIterator& last1, const InputIterator& first2, 
                    const OutputType& init, const BinaryFunction1& f1, const BinaryFunction2& f2, const std::string& user_code)
            {
            ...
            typename std::enable_if<std::is_base_of<typename device_vector<typename std::iterator_traits<DVInputIterator>::value_type>::iterator,DVInputIterator>::value, OutputType>::type
            inner_product_pick_iterator(bolt::cl::control &ctl,  const DVInputIterator& first1, const DVInputIterator& last1, const DVInputIterator& first2, 
            const OutputType& init, const BinaryFunction1& f1, const BinaryFunction2& f2, const std::string& user_code)
            {
            ...
            template< typename DVInputIterator, typename OutputType, typename BinaryFunction1,typename BinaryFunction2> 
            OutputType inner_product_enqueue(bolt::cl::control &ctl, const DVInputIterator& first1, const DVInputIterator& last1, const DVInputIterator& first2, 
                const OutputType& init, const BinaryFunction1& f1, const BinaryFunction2& f2, const std::string& cl_code)
            {
