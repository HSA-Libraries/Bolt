...
struct CallCompiler_StableSort {
    ...
    //static void constructAndCompileRadixStableSortInt(std::vector< ::cl::Kernel >* radixStableSortKernels,  
    ...
    //    bolt::cl::compileKernelsString( *radixStableSortKernels, kernelNames, 
    //                                    sort_uint_kernels, instantiationString, 
    //                                    cl_code_dataType, valueTypeName, "", *ctl );
    //}

    //static void constructAndCompileRadixStableSortUintTemplate(std::vector< ::cl::Kernel >* radixStableSortKernels,  
...
//    boost::call_once( initOnlyOnce, boost::bind( CallCompiler_StableSort::constructAndCompileRadixStableSortUintTemplate, 
//        &radixSortUintKernels, RADIX, cl_code +ClCode<T>::get(), "", TypeName<StrictWeakOrdering>::get(), &ctl) );
...
//    boost::call_once( initOnlyOnce, boost::bind( CallCompiler_StableSort::constructAndCompileRadixStableSortInt, 
//                                                 &radixSortIntKernels, 
