    ...
    namespace cl {
        ...
        * 
        ...
        private:
             ...
             * a buffer is finished being used by a client.  This most likely will happen in the default destrctor
             * generated by the smart_ptr<> class, however, a client also has the option of calling release()
